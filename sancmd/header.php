...
<head>
	...
	body {
                ...
                padding-left: 20px;
                padding-right: 20px;
                background-image: url('images/IBM_V5000_rackmount.jpg');
                background-size: 100%;
	     }
        </style>
...
// -->
	...
	<ul class="nav">
            ...
            <li class="active" ><h4>CMD Generator &nbsp;</h4></li>
            ...
            <li class="active"><a href="index.php">SAN cmd generator</a></li>
