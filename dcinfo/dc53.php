...
if(!isset($_GET['dc']))
{
    header("Location: dc53.php?dc=dc53");
}
?>
      ...
      function drawChartCPU() {
        ...
        var data = google.visualization.arrayToDataTable([
          ...
          $cpu_query = "select abs(sum(configurable_sys_proc_units) - sum(curr_avail_sys_proc_units)) as used_cpu,"
                  ...
                  . " from ms_cpu where ms_name not like 'sysh___-%' and ms_name not like 'sys__-%' and ms_name not like 'is40%'";
      ...
      function drawChartRAM() {
        ...
        var data = google.visualization.arrayToDataTable([
          ...
          $query = "select sum(curr_avail_sys_mem)/1024/1024 as free_mem, "
                  ...
                  . " from ms_mem where ms_name not like 'sysh___-%' and ms_name not like 'sys__-%' and ms_name not like 'is40%'";
                ...
                <div class="container" style="width:50%; float:right">
                    ...
                    <?php
                        ...
                        $cpu_query = "  SELECT Abs(SUM(configurable_sys_proc_units)) AS
                                        ...
                                        used_percentage
                                        FROM   ms_cpu
                                        WHERE ms_name not like 'sysh___-%' and ms_name not like 'sys__-%' and ms_name not like 'is40%'";
                        $cpu_result = mysqli_query($db, $cpu_query);
                    ...
                    <tbody>
                      <?php
                        ...
                        $mem_query = "select truncate(sum(curr_avail_sys_mem)/1024/1024,2) as free_mem,"
                                    ...
                                    . " truncate((sum(configurable_sys_mem)/1024/1024),2) as total_mem,"
