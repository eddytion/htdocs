...
<div class="alert alert-warn"><strong>Note: </strong>Make sure to select a Managed System with enough free resources</div>
<hr>
<form action="step3.php" method="post" enctype="multipart/form-data">
<select name="ms" required>
<?php
if(isset($_POST['hmc']) && !empty($_POST['hmc']) && is_string($_POST['hmc']))
{
